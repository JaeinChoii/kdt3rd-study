...
todoForm.addEventListener('submit', function (event) {
  ...
  // input 창 초기화
  todoInput.value = ''; // input의 content를 빈 문자열로 설정 초기화
...
keyInput.addEventListener('keydown', function (event) {
  // keydown: 키를 누르고 있을 때
  // console.log(event); // 이벤트와 이벤트 객체에 대한 정보 출력
...
const keyInput2 = document.querySelector('#key-input2');
console.log(keyInput2);
keyInput2.addEventListener('keyup', function (e) {
  console.log(e.code);
