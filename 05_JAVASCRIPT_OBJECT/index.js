...
// 동떨어진 인덱스 번호로 원소값 추가; 그 사이에 빈 값 추가됨
arr1[10] = '얍';
console.log(arr1);
...
arr2.unshift('hi');
console.log(arr2);
arr2.unshift('a', 'b'); // 여러 개 추가 가능, 항상 맨 앞에 추가됨!
console.log(arr2);
...
console.log(cat.age);
console.log(cat.mew()); // mew는 함수였으므로 괄호까지 포함
