...
const uploadDetail = multer({
    storage: multer.diskStorage({
        destination(req, file, done) {
            // req: 요청에 대한 정보
            // file: 업로드하는 파일에 대한 정보
            // done(에러, 저장경로): 함수(콜백함수)
...
app.post('/upload', uploadDetail.single('userfile'), function (req, res) {
    ...
    //     originalname: '1.jpg', // 원본 파일명
    //     encoding: '7bit', // 파일 엔코딩 설정
    //     mimetype: 'image/jpeg', // 파일 타입
    //     destination: '/uploads', // 파일을 저장할 경로(폴더)
    //     filename: '37bcd7d03ff1a736ab4be77a4edb4b84', // destination에 저장된 파일명
    //     path: '\\uploads\\37bcd7d03ff1a736ab4be77a4edb4b84', // 업로드된 파일 전체 경로
    //     size: 2554179 // 파일 크기 (byte)
    //   }
