...
// 함수 내부 코드의 최종 값을 저장 및 보관하려고 등장한 키워드
helloWorld2();
...
hello4('안녕?', 'Sean2') // '안녕? 나는 Sean이야'
console.log(hello4('안녕?', 'Sean2')) // console.log('안녕? 나는 Sean이야')
...
console.log(song.length); // song 변수의 문자열 길이. 문자열 길이는 공백도 포함하여 계산
...
// msg2 변수의 양 끝 공백 제거 후 대문자로 변경

var msg3 = '   hi hi I am Jane';
console.log(msg3.trim().toUpperCase());
console.log(msg3.length);
console.log(msg3.trim().length)
...
// - replaceAll(교체될 값, 교체되어 들어가는 값): 발견한 값을 모두 찾아 교체
...
console.log(fruit.indexOf('mango')); // 5 맨 앞 글자의 위치 반환
...
console.log(msg.replace('so', 'very'));
